...
class HumanoidChar(LeggedRobot):
    ...
    def _reset_dofs(self, env_ids, dof_pos, dof_vel):
        ...
        dof_pos_reset = self.dof_pos[env_ids].clone()
        dof_vel_reset = self.dof_vel[env_ids].clone()
        dof_pos_reset, dof_vel_reset = self._enforce_locked_dof_state(dof_pos_reset, dof_vel_reset)
        self.dof_pos[env_ids] = dof_pos_reset
        self.dof_vel[env_ids] = dof_vel_reset
